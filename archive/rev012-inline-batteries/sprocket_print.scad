// REV 011 copy — the 11T wheel for the uncut Ø165 rim. Geometry is IDENTICAL to
// Rev 009's (this file has no dependency on B/D/drop/A, so lowering the hub in
// Rev 011 does not touch the sprocket). Keep `rev = 9` below: it selects the
// 11T/uncut-rim wheel, which is what Rev 011 uses. STLs: stl/rev011_*.stl
// ============================================================================
